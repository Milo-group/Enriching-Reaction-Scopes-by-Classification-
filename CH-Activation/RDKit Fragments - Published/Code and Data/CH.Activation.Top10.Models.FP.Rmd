---
title: "CH Activation - Model Testing - Extra Samples"
output:
  word_document:
    highlight: null
editor_options:
...
# Validation of Samples with 50% Deuteration and Below

## Truncated Datasets - Union of Similarity within Groups and with Group 3

## Without Amine - Top Ten Models 
...
knitr::kable(MP.models.gauss.union50) # present list of models
write.csv(MP.models.gauss.union50, 'fingerprints_model_4_features.csv')
...
### 1st Place
``` {r 1.1}
test.form <- MP.models.gauss.union50[1, 1]
...
### 2nd Place
``` {r 2.1}
test.form <- MP.models.gauss.union50[2, 1]
...
### 3rd Place
``` {r 3.1}
test.form <- MP.models.gauss.union50[3, 1]
...
### 4th Place
``` {r 4.1}
test.form <- MP.models.gauss.union50[4, 1]
...
### 5th Place
``` {r 5.1}
test.form <- MP.models.gauss.union50[5, 1]
...
### 6th Place
``` {r 6.1}
test.form <- MP.models.gauss.union50[6, 1]
...
### 7th Place
``` {r 7.1}
test.form <- MP.models.gauss.union50[7, 1]
...
### 8th Place
``` {r 8.1}
test.form <- MP.models.gauss.union50[8, 1]
...
### 9th Place
``` {r 9.1}
test.form <- MP.models.gauss.union50[9, 1]
...
### 10th Place
``` {r 10.1}
test.form <- MP.models.gauss.union50[10, 1]
