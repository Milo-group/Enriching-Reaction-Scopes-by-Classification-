...
# Load data
ClSulfonyl <- read.csv('Data/Sulfonyl_3-Cl_Final.csv')
rownames(ClSulfonyl) <- ClSulfonyl[,2]
ClSulfonyl <- ClSulfonyl[,-c(1,2,83)] # Removes names and inchies

# Convert the first 158 columns to numeric values
ClSulfonyl[,c(17:80)] <- as.numeric(as.matrix(ClSulfonyl[,c(17:80)]))

# data set as factor
ClSulfonyl[, c(1:16, 81)] <- lapply(ClSulfonyl[, c(1:16, 81)], function(x) {
...
# Load data
PyfluoroSulfonyl <- read.csv('Data/Sulfonyl_pyfluoro_Final.csv')
rownames(PyfluoroSulfonyl) <- PyfluoroSulfonyl[,2]
PyfluoroSulfonyl <- PyfluoroSulfonyl[,-c(1,2,83)] # Removes names and inchies

# Convert the first 158 columns to numeric values
PyfluoroSulfonyl[,c(17:80)] <- as.numeric(as.matrix(PyfluoroSulfonyl[,c(17:80)]))

# data set as factor
PyfluoroSulfonyl[, c(1:16, 81)] <- lapply(PyfluoroSulfonyl[, c(1:16, 81)], function(x) {
  as.factor(as.numeric(x))
})
# Add a 'flag' column to sequentially number the rows
...
# Load data
PyfluoroSulfonyl <- read.csv('ExtraAnalysis_Pyfluoro/Sulfonyl_pyfluoro_Binary_Final.csv')
rownames(PyfluoroSulfonyl) <- PyfluoroSulfonyl[,2]
PyfluoroSulfonyl <- PyfluoroSulfonyl[,-c(1,2,83)] # Removes names and inchies
...
# Load data
PyfluoroSulfonyl <- read.csv('ExtraAnalysis_Pyfluoro/Sulfonyl_pyfluoro_Multi_Final.csv')
rownames(PyfluoroSulfonyl) <- PyfluoroSulfonyl[,2]
PyfluoroSulfonyl <- PyfluoroSulfonyl[,-c(1,2,79)] # Removes names and inchies

# Convert the columns to numeric values
PyfluoroSulfonyl[,c(13:76)] <- as.numeric(as.matrix(PyfluoroSulfonyl[,c(13:76)]))

# data set as factor
PyfluoroSulfonyl[, c(1:12, 77)] <- lapply(PyfluoroSulfonyl[, c(1:12, 77)], function(x) {
  as.factor(as.numeric(x))
})
# Add a 'flag' column to sequentially number the rows
PyfluoroSulfonyl <- plyr::mutate(PyfluoroSulfonyl, flag = seq(1,nrow(PyfluoroSulfonyl)))
...
# Load data
CF3Sulfonyl <- read.csv('Data/Sulfonyl_3-CF3_Final.csv')
rownames(CF3Sulfonyl) <- CF3Sulfonyl[,2]
CF3Sulfonyl <- CF3Sulfonyl[,-c(1,2,83)] # Removes names and inchies

# Convert the first 158 columns to numeric values
CF3Sulfonyl[,c(17:80)] <- as.numeric(as.matrix(CF3Sulfonyl[,c(17:80)]))

# data set as factor
CF3Sulfonyl[, c(1:16, 81)] <- lapply(CF3Sulfonyl[, c(1:16, 81)], function(x) {
  as.factor(as.numeric(x))
})
# Add a 'flag' column to sequentially number the rows
...
# Load data
NO2Sulfonyl <- read.csv('Data/Sulfonyl_3-NO2_Final.csv')
rownames(NO2Sulfonyl) <- NO2Sulfonyl[,2]
NO2Sulfonyl <- NO2Sulfonyl[,-c(1,2,83)] # Removes names and inchies

# Convert the first 158 columns to numeric values
NO2Sulfonyl[,c(17:80)] <- as.numeric(as.matrix(NO2Sulfonyl[,c(17:80)]))

# data set as factor
NO2Sulfonyl[, c(1:16, 81)] <- lapply(NO2Sulfonyl[, c(1:16, 81)], function(x) {
  as.factor(as.numeric(x))
})
# Add a 'flag' column to sequentially number the rows
...
# Perform similarity-based sampling
# Similarity-based sampling for each class
one <- simi.sampler(NO2Sulfonyl, 1)  # Sample from class 1
...
# Load data
PBSFSulfonyl <- read.csv('Data/Sulfonyl_PBSF_Final.csv')
rownames(PBSFSulfonyl) <- PBSFSulfonyl[,2]
PBSFSulfonyl <- PBSFSulfonyl[,-c(1,2,82)] # Removes names and inchies

# Convert the first 158 columns to numeric values
PBSFSulfonyl[,c(16:79)] <- as.numeric(as.matrix(PBSFSulfonyl[,c(16:79)]))

# data set as factor
PBSFSulfonyl[, c(1:15, 80)] <- lapply(PBSFSulfonyl[, c(1:15, 80)], function(x) {
  as.factor(as.numeric(x))
})
# Add a 'flag' column to sequentially number the rows
